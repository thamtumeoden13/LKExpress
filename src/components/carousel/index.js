...
export default class example extends Component {
    ...
    layoutExample(number, title, type) {
        ...
        return (
            <View style={[styles.viewContainer, isTinder ? styles.viewContainerDark : styles.viewContainerLight]}>
    ...
    customExample(number, title, refNumber, renderItemFunc) {
        ...
        return !IS_ANDROID ? (
            <View style={[styles.viewContainer, isEven ? styles.viewContainerDark : styles.viewContainerLight]}>
